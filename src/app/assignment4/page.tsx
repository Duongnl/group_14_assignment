...
const images = [
  { src: '/images/anh1.webp', alt: 'Image 1', width: 600, height: 400 },
  { src: '/images/anh2.jpg', alt: 'Image 2', width: 600, height: 400 },
  { src: '/images/anh3.webp', alt: 'Image 3', width: 600, height: 400 },
];
const Assignment4 = () => {
    return (
